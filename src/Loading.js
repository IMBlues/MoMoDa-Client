/**
 * Created by Yu on 2014/12/24 0024.
 */
var loadindLayer = cc.LayerColor.extend({//继承LayerColor，初始化的时候可以直接改背景颜色
    ...
    ctor : function() {
        ...
        ccs.armatureDataManager.addArmatureFileInfoAsync(res.s_PlayBackGround, s_FullPlist, " ",this.loadCall,this);
        cc.textureCache.addImage(res.s_PlayBackGround,this.loadCall,this);
        cc.loader.load(res.s_PlayBackGround, this.loadCall,this);
    },
    ...
    loadCall : function() {
        ...
        if (this.a == 3) {
            ...
            var trans = new cc.TransitionPageTurn(0.5, new StartScene(), false);
